...
* **Integrate** energy purchasing into your dApp or backend with the [REST API](developers/api-reference/) or the [SDK](developers/sdk.md) (TypeScript, Rust, Python, Java, PHP).
...
_Need help? Reach out on_ [_Telegram_](https://t.me/wantingtrx) _or read the_ [_FAQ_](resources/faq.md)_._
