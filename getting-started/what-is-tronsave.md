---
description: TronSave is a marketplace for renting and managing TRON Energy & Bandwidth.
---

# What is TronSave?

**TronSave** is a marketplace built on TRON **Stake 2.0** that lets you **rent Energy and Bandwidth** instead of burning TRX on every transaction — cutting the cost of on‑chain actions (like USDT TRC‑20 transfers) by up to **~92%**.

It serves two sides of the same market:

* **Buyers** rent Energy/Bandwidth on demand — via the [website](../guides/buy/README.md), [Telegram](../guides/buy/on-telegram/README.md), or the [API](../developers/quickstart.md) — and pay far less than the equivalent burned TRX.
...
* [Why TronSave?](why-tronsave.md) — the concrete benefits for users and providers
* [How It Works](how-it-works.md) — the rental flow end to end
* [Quickstart](quickstart.md) — buy your first Energy in under 10 minutes
