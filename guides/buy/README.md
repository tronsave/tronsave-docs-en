---
description: >-
  Every way to buy Energy and Bandwidth on TronSave — website, Telegram, ZapBuy,
  and Auto Buy.
---
...
➡️ [**Buy on the Website**](on-the-website/) - [Normal](on-the-website/normal-order.md) · [Pending](on-the-website/pending-order.md) · [Smart](on-the-website/smart-order.md)
...
{% hint style="info" %}
Building an integration? Developers can buy programmatically via the API — see the [Developer Quickstart](../../developers/quickstart.md) and [API Reference](../../developers/api-reference/).
{% endhint %}
...
* [Buy on the Website](on-the-website/) · [Buy on Telegram](on-telegram/) · [ZapBuy](zapbuy.md) · [Auto Buy](auto-buy.md)
